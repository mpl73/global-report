...
class VariaveisMonitoradasView(LoginRequiredMixin, TemplateView):
    template_name = 'variaveis_monitoradas/variaveis_monitoradas.html'

    def get_context_data(self, **kwargs):
        context = super(VariaveisMonitoradasView, self).get_context_data(**kwargs)
        context['title'] = 'Variaveis Monitoradas'
