...
class DriverSiemensView(LoginRequiredMixin, TemplateView):
    template_name = 'driver_siemens/driver_siemens.html'

    def get_context_data(self, **kwargs):
        context = super(DriverSiemensView, self).get_context_data(**kwargs)
        context['title'] = 'Driver Siemens'
