...
class DriverOPCView(LoginRequiredMixin, TemplateView):
    template_name = 'driver_opc/driver_opc.html'

    def get_context_data(self, **kwargs):
        context = super(DriverOPCView, self).get_context_data(**kwargs)
        context['title'] = 'Driver OPC'
