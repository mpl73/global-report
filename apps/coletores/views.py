...
class ColetoresView(LoginRequiredMixin, TemplateView):
    template_name = 'coletores/coletores.html'

    def get_context_data(self, **kwargs):
        context = super(ColetoresView, self).get_context_data(**kwargs)
        context['title'] = 'Coletores'
