...
class HistoricoAlarmesView(LoginRequiredMixin, TemplateView):
    template_name = 'historico_alarmes/historico_alarmes.html'

    def get_context_data(self, **kwargs):
        context = super(HistoricoAlarmesView, self).get_context_data(**kwargs)
        context['title'] = 'Histórico de Alarmes'
